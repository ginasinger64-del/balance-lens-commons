...
def simulate(mode, N=500, T=4000, burn=2000, Tsel=0.5, mu=0.005,
    ...
    for t in range(T):
        ...
        if mode=='repair':
            ...
            p2=5.0; restore=0.0
        # resource update
        R=R+g*R*(1.0-R/Rmax)-delta*fD*Rmax+restore+1.0
...
print("FINITE-N (N=500, +recruitment s0=1.0 to avoid R=0 absorbing trap) + FERMI imitation. a=2.0, g=delta=0.20, kappa=2, cost=1, redist=1.")
